...
public class Arrayist {
    ...
    public static String printIsPossible(ArrayList<Data> data, int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (data.get(i).getXi() == 0 && data.get(i).getYi() == 1) continue;
            ...
            if (!isXYNorthEast(data.get(i).getXi(), data.get(i).getYi()) && ((data.get(i).xi > -1 && (data.get(i).xi < data.get(i).yi)) || (data.get(i).xi < 1 && (data.get(i).xi < data.get(i).yi)))) {
            ...
            } else if (!isXYNorthEast(data.get(i).getXi(), data.get(i).getYi()) && ((data.get(i).xi > -1 && (data.get(i).xi > data.get(i).yi)) || (data.get(i).xi < 1 && (data.get(i).xi > data.get(i).yi)))) {
